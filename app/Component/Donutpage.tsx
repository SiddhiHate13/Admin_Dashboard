...
const IndexPage: React.FC = () => {
  ...
  return (
  <div className=' h-[450px] w-[900px] rounded-lg shadow-gray-600 shadow-sm  bg-white mt-1 ml-[280px] '> {/* Added heading */}

<div className='h-[450px] w-[850px] ml-[30px]  flex items-center justify-center '>
